...
const onSubmit = () =>{
    let id = uuidv4();
    setProducts({id:id,name:titleRef.current.value,quantity:quantityRef.current.value,inStock:true});
    ...
    return (<div>
        <label htmlFor="products">Welcome to list of products</label><br/>
